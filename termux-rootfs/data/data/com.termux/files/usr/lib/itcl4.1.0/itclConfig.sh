...
# String to pass to linker to pick up the Itcl library from its
# installed directory.
itcl_LIB_SPEC='-L/data/data/com.termux/files/usr/lib/itcl4.1.0 -litcl4.1.0'
ITCL_LIB_SPEC='-L/data/data/com.termux/files/usr/lib/itcl4.1.0 -litcl4.1.0'
...
# String to pass to linker to pick up the Itcl stub library from its
# installed directory.
itcl_STUB_LIB_SPEC='-L/data/data/com.termux/files/usr/lib/itcl4.1.0 -litclstub4.1.0'
ITCL_STUB_LIB_SPEC='-L/data/data/com.termux/files/usr/lib/itcl4.1.0 -litclstub4.1.0'
...
# String to pass to linker to pick up the Itcl stub library from its
# installed directory.
itcl_STUB_LIB_PATH='/data/data/com.termux/files/usr/lib/itcl4.1.0/libitclstub4.1.0.a'
ITCL_STUB_LIB_PATH='/data/data/com.termux/files/usr/lib/itcl4.1.0/libitclstub4.1.0.a'
