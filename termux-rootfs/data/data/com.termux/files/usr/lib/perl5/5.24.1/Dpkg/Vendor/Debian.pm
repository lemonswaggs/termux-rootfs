...
sub run_hook {
    ...
    if ($hook eq 'package-keyrings') {
        return ('/data/data/com.termux/files/usr/share/keyrings/debian-keyring.gpg',
                '/data/data/com.termux/files/usr/share/keyrings/debian-maintainers.gpg');
    } elsif ($hook eq 'keyrings') {
        warnings::warnif('deprecated', 'deprecated keyrings vendor hook');
        return $self->run_hook('package-keyrings', @params);
    } elsif ($hook eq 'archive-keyrings') {
        return ('/data/data/com.termux/files/usr/share/keyrings/debian-archive-keyring.gpg');
    } elsif ($hook eq 'archive-keyrings-historic') {
        return ('/data/data/com.termux/files/usr/share/keyrings/debian-archive-removed-keys.gpg');
