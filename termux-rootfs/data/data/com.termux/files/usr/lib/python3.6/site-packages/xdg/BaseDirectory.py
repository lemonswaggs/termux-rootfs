...
xdg_data_dirs = [xdg_data_home] + \
    (os.environ.get('XDG_DATA_DIRS') or '/data/data/com.termux/files/usr/share').split(':')

xdg_config_home = os.environ.get('XDG_CONFIG_HOME') or \
            os.path.join(_home, '.config')

xdg_config_dirs = [xdg_config_home] + \
    (os.environ.get('XDG_CONFIG_DIRS') or '/data/data/com.termux/files/usr/etc/xdg').split(':')
...
def get_runtime_dir(strict=True):
    ...
    try:
        ...
        import getpass
        fallback = '/data/data/com.termux/files/usr/tmp/pyxdg-runtime-dir-fallback-' + getpass.getuser()
        try:
