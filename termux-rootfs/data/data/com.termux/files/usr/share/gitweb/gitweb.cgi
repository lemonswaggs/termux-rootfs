...
sub evaluate_gitweb_config {
	...
	our $GITWEB_CONFIG_SYSTEM = $ENV{'GITWEB_CONFIG_SYSTEM'} || "/data/data/com.termux/files/usr/etc/gitweb.conf";
	our $GITWEB_CONFIG_COMMON = $ENV{'GITWEB_CONFIG_COMMON'} || "/data/data/com.termux/files/usr/etc/gitweb-common.conf";
...
sub mimetype_guess {
	...
	$mime ||= mimetype_guess_file($filename, '/data/data/com.termux/files/usr/etc/mime.types');
	return $mime;
}
